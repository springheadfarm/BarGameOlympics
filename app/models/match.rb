class Match < ActiveRecord::Base
  ...
  scope :unplayed, 		-> { where("started_at is NULL and year=2016") }
  scope :in_progress,	-> { where("started_at is NOT NULL AND ended_at is NULL and year=2016") }
  scope :completed,   -> { where("ended_at is NOT NULL and year=2016") }
